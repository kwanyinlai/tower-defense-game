...
{
    public static readonly float UNWALKABLE = float.MaxValue;
    public readonly float baseWalkCost = 1f;
    ...
    public GridNode(int2 globalPos, float baseWalkCost = 1f) // might have to assign walk cost later on creation
    {
        walkCost = 1f;
        territoryStatus = (int)GridManager.TerritoryStatus.NotAssigned;
        buildable = true;
        this.globalPos = globalPos;
        this.walkCost = baseWalkCost;
    }
